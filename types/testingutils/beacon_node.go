...
var Transactions = func() []bellatrix.Transaction {
	return TestingExecutionPayload().Transactions
}()

var Withdrawals = func() []*capella.Withdrawal {
	return TestingExecutionPayload().Withdrawals
}()
...
var TestingBlindedBeaconBlock = func() *apiv1capella.BlindedBeaconBlock {
...
var TestingWrongBeaconBlock = func() *capella.BeaconBlock {
...
var TestingSignedBeaconBlock = func(ks *TestKeySet) *capella.SignedBeaconBlock {
...
func (bn *TestingBeaconNode) GetSyncCommitteeContribution(slot phase0.Slot, selectionProofs []phase0.BLSSignature, subnetIDs []uint64) (ssz.Marshaler, spec.DataVersion, error) {
	return &TestingSyncCommitteeContributionsConsensusData, spec.DataVersionBellatrix, nil
}
