...
func PreparedPreviouslyDuplicatePrepareQuorum() *tests.MsgProcessingSpecTest {
	...
	return &tests.MsgProcessingSpecTest{
		...
		Pre:      pre,
		PostRoot: "b311c5529371b33bb292da7c5927613280f879c933902cb005b3b83a72b097ee",
		InputMessages: append(msgs, testingutils.SignQBFTMsg(ks.Shares[1], types.OperatorID(1), &qbft.Message{
			MsgType:    qbft.PrepareMsgType,
			Height:     qbft.FirstHeight,
			Round:      2,
			Identifier: []byte{1, 2, 3, 4},
